...
class Trader:
    ...
    def _trade_emeralds(self, order_depth: OrderDepth, pos: int) -> List[Order]:
        ...
        # Take any ask at or below fair value (anomaly bot at 10000)
        ...
        # Take any bid at or above fair value (anomaly bot at 10000)
        ...
        # Passive MM — fixed inside bot walls
        if buy_cap > 0:
    ...
    def _trade_tomatoes(self, order_depth: OrderDepth, pos: int) -> List[Order]:
        ...
        # Penny-jump: 1 tick inside current L1, skew=2 for higher mean PnL
        skew = round(pos / TOMATOES_LIMIT * 2)
